# Contributing to peff_uniprot_fetcher

Bug reports, fixes and new features are welcome. Use the
[issue tracker](https://github.com/tacular-omics/peff_uniprot_fetcher/issues) for bugs and
questions, with a minimal example and the peff_uniprot_fetcher and Python versions. Report
...
```bash
git clone https://github.com/tacular-omics/peff_uniprot_fetcher.git
...
- Add a line under the newest version heading in `HISTORY.md` for user-visible changes.
